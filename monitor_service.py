...
class ServiceMonitor():
    ...
    def __init__(self, local_name, config, lock, write_file, read_file):
    ...
    def monitor_loop(self):
        ...
        while(1):
            try:
                ...
                pass
            for key in self.config[self.local_name]:
                ...
                if datetime.datetime.strptime(get_timestamp(), "%Y-%m-%d %H:%M:%S") >= timestamp + frequency:
                    ...
                    self.config[self.local_name][1][key][6] = status
